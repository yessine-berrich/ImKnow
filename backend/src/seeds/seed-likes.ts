...
const ARTICLE_LIKES: { title: string; likers: string[] }[] = [
  ...
  // Articles enrichis
  { title: 'Vue.js 3 et la Composition API : migration depuis Options API',             likers: ['alexandre.petit@imknow.com', 'thomas.martin@imknow.com', 'julien.leroy@imknow.com', 'nicolas.mercier@imknow.com', 'sophie.laurent@imknow.com', 'lucas.bernard@imknow.com'] },
  { title: 'OWASP Top 10 : sécuriser ses applications web en 2024',                     likers: ['thomas.martin@imknow.com', 'julien.leroy@imknow.com', 'alexandre.petit@imknow.com', 'lea.dubois@imknow.com', 'nicolas.mercier@imknow.com', 'lucas.bernard@imknow.com', 'camille.rousseau@imknow.com'] },
  { title: 'Leadership technique : passer de développeur senior à tech lead',            likers: ['thomas.martin@imknow.com', 'alexandre.petit@imknow.com', 'nicolas.mercier@imknow.com', 'lucas.bernard@imknow.com', 'marie.dupont@imknow.com', 'emma.moreau@imknow.com', 'camille.rousseau@imknow.com', 'sophie.laurent@imknow.com'] },
  { title: "Machine Learning en production : de l'expérimentation au déploiement",      likers: ['thomas.martin@imknow.com', 'julien.leroy@imknow.com', 'alexandre.petit@imknow.com', 'lucas.bernard@imknow.com', 'nicolas.mercier@imknow.com', 'emma.moreau@imknow.com'] },
  { title: 'Next.js 14 et le App Router : migration complète depuis Pages Router',       likers: ['alexandre.petit@imknow.com', 'thomas.martin@imknow.com', 'julien.leroy@imknow.com', 'sophie.laurent@imknow.com', 'nicolas.mercier@imknow.com', 'lucas.bernard@imknow.com'] },
  { title: 'Redis en production : stratégies de cache et patterns avancés',              likers: ['thomas.martin@imknow.com', 'julien.leroy@imknow.com', 'alexandre.petit@imknow.com', 'nicolas.mercier@imknow.com', 'lucas.bernard@imknow.com', 'emma.moreau@imknow.com'] },
  { title: 'CI/CD avec GitHub Actions : pipeline complet pour une application NestJS',  likers: ['thomas.martin@imknow.com', 'alexandre.petit@imknow.com', 'nicolas.mercier@imknow.com', 'lucas.bernard@imknow.com', 'julien.leroy@imknow.com', 'sophie.laurent@imknow.com'] },
  { title: 'Gestion de la performance : conduire des entretiens annuels efficaces',      likers: ['marie.dupont@imknow.com', 'emma.moreau@imknow.com', 'camille.rousseau@imknow.com', 'lea.dubois@imknow.com', 'thomas.martin@imknow.com', 'julien.leroy@imknow.com'] },
  { title: 'SEO technique en 2024 : Core Web Vitals, structured data et indexation',    likers: ['clarisse.renaud@imknow.com', 'emma.moreau@imknow.com', 'marie.dupont@imknow.com', 'sophie.laurent@imknow.com', 'thomas.martin@imknow.com', 'alexandre.petit@imknow.com'] },
  { title: 'Accessibilité web WCAG 2.2 : guide pratique pour les développeurs',         likers: ['sophie.laurent@imknow.com', 'emma.moreau@imknow.com', 'thomas.martin@imknow.com', 'alexandre.petit@imknow.com', 'lea.dubois@imknow.com', 'clarisse.renaud@imknow.com'] },
  { title: 'Gestion de la dette technique : mesurer, prioriser et rembourser',          likers: ['thomas.martin@imknow.com', 'julien.leroy@imknow.com', 'lucas.bernard@imknow.com', 'alexandre.petit@imknow.com', 'nicolas.mercier@imknow.com', 'emma.moreau@imknow.com', 'camille.rousseau@imknow.com'] },
];
